...
@Mod(AwesomeWands.MODID)
public class AwesomeWands {
    public static final String MODID = "awesomewands";
    public static final Logger LOGGER = LogUtils.getLogger();

    public AwesomeWands(IEventBus modEventBus, ModContainer modContainer) {
        modEventBus.addListener(this::commonSetup);
        NeoForge.EVENT_BUS.register(this);
        AwesomeBlocks.register(modEventBus);
    ...
    public void onServerStarting(ServerStartingEvent event) {
        LOGGER.info("Awesome Wands creates magic properly!");
    }
}
